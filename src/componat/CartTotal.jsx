  ...
  return (
    <div className="box w-[35%] py-[70px]">
      ...
      <>
       ...
       <h2 className='bg-[#19D16F] text-[#fff] mt-[20px] rounded w-[200px] h-[50px] flex justify-center items-center text-[18px] font-[600]'><Link to={'/Login'}>Login Now</Link></h2>
       </div>
       </div>
        ...
        item.map((data) => (
          <div className="copon w-[100%]">
            ...
            <div className="coponBox bg-[#E8E6F1] w-[100%] p-[20px] h-[300px] rounded-[20px]">
              ...
              <h2 onClick={updateUserD} className='w-[65%] h-[50px] text-[17px] font-[600] py-[20px] flex justify-center mt-[60px] items-center text-[#fff] bg-[#FB2E86] rounded-[10px]'>Submit</h2>
            </div>
          </div>
        ))
      ))}
