  ...
  return (
    <div className="Mainbox py-[70px] w-[100%]">
        <div className="LoginBox rounded-[7px] p-[30px] bg-[#F8F8FB] w-[544px] h-[474px] mx-auto">
            ...
            <h2 onClick={LoginNow} className=' cursor-pointer  w-[100%] h-[50px] bg-[#FB2E86] text-[#fff] text-[18px] mb-[35px] flex justify-center items-center rounded font-[600]'>Sing in</h2>
